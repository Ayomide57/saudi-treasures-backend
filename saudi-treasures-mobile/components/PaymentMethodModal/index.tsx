import {
  ...
  export default function PaymentMethodModal({title, paymentMethod, setPaymentMethod, style, style2}: IChoosePayment) {
    ...
    return (
      <SafeAreaProvider className="">
        ...
        <BottomModal
          ...
          <TouchableOpacity className="flex-row justify-between bg-[#FAF5FF] p-3 items-center mt-5 mb-10 rounded-2xl">
            <View className="flex-row items-center">
              <MaterialIcons
                size={18}
                className="rounded-full p-3 mr-6"
          ...
          >
            <View className="w-fit pl-5 pr-5 mt-5">
              ...
              <CustomButton
                ...
                onPress={() => router.navigate('../(payment)/SuccessMessage')} />
            </View>
          </BottomModal>
          </SafeAreaView>
